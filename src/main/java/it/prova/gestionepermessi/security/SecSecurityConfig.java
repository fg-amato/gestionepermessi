...
public class SecSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
         ...
         .antMatchers("/utente/edit", "utente/insert", "utente/list", "utente/search", "utente/show").hasRole("ADMIN")
         .antMatchers("/utente/change/").hasAnyRole("ADMIN", "DIPENDENTE_USER")
         ...
         .antMatchers("/richieste_permesso/search").hasRole("BO_USER")
         .antMatchers("/richieste_permesso/search_personal","/richieste_permesso/insert").hasRole("DIPENDENTE_USER")
         .antMatchers("/richieste_permesso/list").hasAnyRole("BO_USER", "DIPENDENTE_USER")
